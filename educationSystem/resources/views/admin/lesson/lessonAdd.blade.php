    ...
    <form action="" method="post" class="form form-horizontal" id="form-lesson-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" id="lesson_name" name="lesson_name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select class="select" size="1" name="course_id">
					<option value="" selected>--请选择对应课程--</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input type="radio" value="1" name="is_able" checked>
                    <label for="lesson_start">启用</label>
                </div>
                <div class="radio-box">
                    <input type="radio" value="0" name="is_able">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="分钟" name="lesson_duration" id="lesson_duration">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input class="input-text upload-url" type="text" name="video_address" id="video_address" readonly
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input class="input-text upload-url" type="text" name="cover_img" id="cover_img" readonly
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#form-lesson-add').submit(function(evt){
            ...
            //ajax提交
            $.ajax({
                url:'{{url("admin/lesson/lessonAdd")}}',
                data:data,
                dataType:'json',
                type:'post',
