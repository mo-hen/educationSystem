...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick="live_add('添加直播课程','/admin/live/live_add','800','500')" class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 添加直播课程
			</a>
		</span>
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$v->created_at}}</td>
				<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="live_edit('直播课程编辑','/admin/live/live_edit/{{$v->mg_id}}','1','800','500')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i>
					</a>
					&nbsp;&nbsp;
					<a title="删除" href="javascript:;" onclick="admin_del(this,'<?php echo $v->mg_id ?>')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6e2;</i>
					</a>
				</td>
			</tr>
