...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
			...
			<a href="javascript:;" onclick="admin_add('添加权限','/admin/permission/add','800','500')"
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        @foreach($info as $v)
            <tr class="text-c">
                ...
                <td>{{$v['ps_id']}}</td>
                <td style="text-align:left;text-indent: 1em;">{{str_repeat('----',$v['ps_level'])}}{{$v['ps_name']}}</td>
                <td>{{$v['ps_pid']}}</td>
                <td>{{$v['ps_c']}}</td>
                <td>{{$v['ps_a']}}</td>
                <td>{{$v['address']}}</td>
                ...
                <td class="td-manage">
                    <a title="编辑" href="javascript:;"
                       onclick="admin_edit('权限编辑','/admin/permission/edit/{{$v['ps_id']}}','800','500')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a title="删除" href="javascript:;" onclick="admin_del(this,'{{ $v['ps_id'] }}')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                </td>
