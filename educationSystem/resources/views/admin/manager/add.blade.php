...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">头像预览</label>
            <div class="formControls col-xs-8 col-sm-9">
                <p><img id="show_pic" src="" alt="头像" style="display: none;" width="200" height="100"/></p>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="mg_remark" id="mg_remark" style="width:550px;height:110px;"></textarea>
...
<script type="text/javascript">
    $(function () {
        ...
        /*
         ...
         parent.$('#ref_btn').click();
         //			parent.document.getElementById(ref_btn).click();
