...
<header>
    <div class=" learingHeader">
        <nav class="navbar container">
            ...
            <div class="navbar-left">
                <input type="text" class="input-search" placeholder="输入查询关键词">
                <input type="submit" class="search-buttom">
            </div>
            <div class="navbar-right" style="margin-top: 18px;">
            ...
            <div>
                <a href="{{url('home/shop/cart_account')}}" class="btn btn-primary" style="position: absolute; top: 10px; right: -105px;">去购物车结算</a>
            </div>
