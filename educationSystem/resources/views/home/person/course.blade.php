...
<header>
    <div class=" learingHeader">
        <nav class="navbar container">
            ...
            <div class="navbar-left"><input type="text" class="input-search" placeholder="输入查询关键词"><input type="submit"
                                                                                                          class="search-buttom">
            </div>
...
<div class="container" style="background: #fff;">
    <div class="personal-nav pull-left">
        <div class="nav nav-stacked text-left">
            ...
            <div class="item">
                <li class="active"><a href="" class="glyphicon glyphicon-tower"> 我的课程<i class="pull-right">></i></a>
                </li>
    ...
    <div class="personal-content pull-right">
        <div class="personal-cont">
            ...
            <div class="my-course">
                <div class="tit">
                    <span class="active hv-poin">我加入的课程</span>
                    <span class="nv-poin">我购买的课程</span>
                </div>
                <div class="cont">
                    <div class="col-lg-6">
                        <div class="item">
                            <div class="imgIco"><img src="/home/img/widget-timg.jpeg" width="50" height="50" alt="">
                            </div>
            ...
            <div class="my-collection">
                <div class="tit">
                    <span class="hv-poin">我关注的课程</span>
                    <span class="nv-poin">直播课程展示</span>
                </div>
                <div class="cont">
                    @foreach($lives as $v)
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="imgIco">
                                    <img src="/home/img/page-topIco.png" width="50" height="50" alt="">
                                </div>
                                <div class="title">{{$v->course_name}}</div>
                                ...
                                @if($v->access=='1')
                                    <div class="text-center"><a title="点击进入" href="#" class="btn btn-primary">直播中</a></div>
                                @elseif($v->access=='0')
                                    <div class="text-center"><a href="javascript:void (0);" class="btn btn-primary">直播未开始</a></div>
                                @else
                                    <div class="text-center"><a disabled href="javascript:void (0);" class="btn btn-primary">直播已结束</a></div>
                                @endif
                            </div>
                        </div>
                    @endforeach
