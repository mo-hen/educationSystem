...
<div class="learing-course">
    ...
    <div class="course-weeklist">
        <div class="nav nav-stacked">
            <div class="tit nav-justified text-center"><i class="pull-left glyphicon glyphicon-chevron-left">
                </i>第一周软件安装 <i class="pull-right">1/4</i>
            </div>
                    ...
                    @foreach($dan_info as $v)
                        <li class="problem-choice">
                            ...
                            @if($v->answer->right_wrong=='对')
                                <div class="problem-tit"><i class="">√</i>正确
                            ...
                            @endif
                                这个题你答【{{$v->answer->right_wrong}}】了 +{{$v->answer->answer_score}} 分
                                    <span class="pull-right">
                                        <div class="star">
                                            <div class="score" style="width: 31.4px;">
                                                <i>4</i>
                                            </div>
                                        </div>
                                    </span>
                                ...
                                <label>
                                    <input type="radio" value="8" disabled="disabled"
                    ...
                    @foreach($duo_info as $v)
                        <li class="problem-choice">
                            ...
                            这个题你答【{{$v->answer->right_wrong}}】了 +{{$v->answer->answer_score}} 分
                                    <span class="pull-right">
                                        <div class="star">
                                            <div class="score"style="width: 31.4px;"><i>4</i></div>
                                        </div>
                                    </span>
                                </div>
                                ...
                                <div class="problem-explain">
                                    ...
                                    <div>
                                        您的答案：{{\App\Http\Models\Question::$QUESTION_ANSWER[$v->answer->answer_result]}}</div>
                                    <div class="correct">
                                        正确答案：{{\App\Http\Models\Question::$QUESTION_ANSWER[$v->qs_answer]}}</div>
                                    <div class="explain">
                                        函数运行题
                                    </div>
                                </div>
    ...
    <div class="course-evaluate" style="display: none;">
        ...
        <div class="evaluate">
            <div class="title"> 您的评论：
                ...
                <span class="star-score"> <i>0</i>分</span>
