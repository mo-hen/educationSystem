            ...
            <div class="course-cont-top-video" style="position: relative;height:500px;">
                <div class="course-weeklist" style="left:0">
                    <div class="nav nav-stacked">
                        <div class="tit nav-justified text-center"><i
                                    class="pull-left glyphicon glyphicon-chevron-left"></i>第一周软件安装 <i
                                    class="pull-right">1/4</i></div>
                ...
                <div class="video-box" style='width:986px;'>
                    ...
                    <div class="video text-center"
                         style='width:900px;height:450px;background-color:pink;clear:both;margin:auto;' id="show_video">
                    </div>
                    <script type="text/javascript">
                        var flashvars = {
                            f: '{{$pullurl}}',       //拉流地址
                            i: '/ckplayer/share/1.jpg',//视频封面图
                            d: '/ckplayer/share/4.jpg|/ckplayer/share/5.jpg|/ckplayer/share/6.jpg',//暂停时播放的广告图片
                            v: '60',//默认音量，0-100之间
                            p: '0',//视频默认0是暂停，1是播放
                            lv: '0',//是否是直播流，=1则锁定进度栏
                            c: 0,
            ...
            <div class="subtitle-cont">
                <div class="container">
                    ...
                    <div class="video-textes">
                        <li><span>0：00</span>[音乐]最后一个主题，我想涵盖的介绍材料，在我们真正开始的过程，并开始在这个惊人的旅程，只是一个高层次的纲要，我们要去。我想这是可选的，因为，首先，它是罚款，只要开始，看看我们要去那里，我们到达那里。但也因为没有办法讨论的过程中，在短短几分钟内没有使用一堆术语和术语，我不希望你知道。整个过程的重点是让你了解这些事情，我恨你看这个视频，认为，我不知道他在走动，我想我不应该继续下去，当这就是为什么你应该继续。
                        </li>
                        <li><span>4：00</span>这样你就可以了解所有这些事情，我们将解释一件一次。有了这一点，让我们给概述，以防你看到这些东西之前，想知道，我要去一些新的东西，或者我听说我真的想了解一些东西，这是要来了吗？我当然不会列出这里的每一个主题。有太多，有很多星期价值的东西，但在一个非常高的水平。这部分的合唱，我们要做的功能性编程的基础知识，EMA的静态类型的语言，即ML.首先是基础知识，如变量和范围、数量和加。不要担心，当然你以前见过，但在编程之前，但在一个精确的方式。我们将建立功能，我喜欢的方法，但没有对象，如果你看到面向对象编程。我们要做递归，实际上这是我们要写计算以及其他计算的方式。我们要建立更大的数据结构的元组和列表的方式。这将是第一节。因此，与软件安装的东西，这是一个公平的数额，特别是在一个不寻常的环境。所以我们给额外的时间，这真的像你有两倍长的那一节，为那些跟随。
                        </li>
                        <li><span>9:54</span>之后，第二节是所有关于数据类型和模式匹配。这是一种新的方式，你们大多数人以前没有见过，以代表更大的数据结构，模型不同的数据</li>
                        <li><span>10：30</span>我想涵盖的介绍材料，在我们真正开始的过程，并开始在这个惊人的旅程，只是一个高层次的纲要，我们要去。我想这是可选的，因为，首先，它是罚款，只要开始，看看我们要去那里，我们到达那里。但也因为没有办法讨论的过程中，在短短几分钟内没有使用一堆术语和术语，我不希望你知道。整个过程的重点是让你了解这些事情，我恨你看这个视频，认为，我不知道他在走动，我想我不应该继续下去，当这就是为什么你应该继续。
                        </li>
