...
<div class="register">
    ...
    <div class="register-body">
        <div class="register-cent">
            ...
            <form class="required-validate" id="regStudentForm" method='post' action="{{url('home/student/login')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="std_name" placeholder="请输入登录名"
                                       value="{{old('std_name')}}"/>
                                <span class="verif-span">{{$errors->first('std_name')}}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="password" class="form-control" name="password" placeholder="请输入密码"
                                       value="{{old('password')}}">
                                <span class="verif-span">{{$errors->first('password')}}</span>
                            </div>
                        </div>
                    </li>
