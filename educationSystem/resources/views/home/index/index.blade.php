    ...
    <div class=" learingHeader">
        <div class="navbar container">
            <div class="navbar-left">
                <img src="/home/img/asset-logoIco.png" alt="">
            </div>
            <div class="navbar-left">
            ...
            <div class="navbar-left"><input type="text" class="input-search" placeholder="输入查询关键词">
            ...
            <div class="conten" id="a">
                <div class="row text-center top">
                    ...
                    <div class="col-lg-3 text-right">
                        <a href="{{url('home/course/detail',['course'=>$v->course_id])}}" class="btn btn-default ck-all"
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div>
                    <!--<h1 style="display: inline-block">学成网</h1>--><img src="/home/img/asset-logoIco.png" alt="">
                </div>
