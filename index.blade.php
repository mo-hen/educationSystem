        ...
        <div class="container-fluid cl">
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li>超级管理员</li>
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">{{Auth::guard('admin')->user()->username}}<i
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-teacher">
            ...
            <dd>
                <ul>
                    <li><a data-href="member-list.html" data-title="教师列表" href="javascript:;">教师列表</a></li>
                    <li><a data-href="member-del.html" data-title="删除的教师" href="javascript:;">删除的老师</a></li>
                    <li><a data-href="member-level.html" data-title="等级管理" href="javascript:;">等级管理</a></li>
                    <li><a data-href="member-scoreoperation.html" data-title="积分管理" href="javascript:;">积分管理</a></li>
                </ul>
            </dd>
        ...
        <dl id="menu-product">
            <dt><i class="Hui-iconfont">&#xe620;</i> 课程中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="/admin/lesson/index" data-title="课时管理" href="javascript:void(0)">课时管理</a></li>
                    <li><a data-href="/admin/stream/index" data-title="直播流管理" href="javascript:void(0)">直播流管理</a></li>
                    <li><a data-href="/admin/live/index" data-title="直播课程管理" href="javascript:void(0)">直播课程管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-href="/admin/manager/role" data-title="角色管理" href="javascript:void(0)">角色管理</a>
                    </li>
                    <li>
                        <a data-href="/admin/manager/permission" data-title="权限管理" href="javascript:void(0)">权限管理</a>
                    </li>
                    <li>
                        <a data-href="/admin/manager/showlist" data-title="管理员列表" href="javascript:void(0)">管理员列表</a>
                    </li>
                </ul>
            </dd>
        </dl>
